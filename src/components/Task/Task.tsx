...
const Task = ({ 
  ...
  <div className="task rounded-lg flex flex-col shadow-lg bg-white p-3" data-testid="task">
    <img src={picture} alt="Card background" className="object-cover rounded-lg" />
